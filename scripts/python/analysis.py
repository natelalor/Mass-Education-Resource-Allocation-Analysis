...
def main():
    ...
    ###### changes standardized_testing_results into 1 row per district_code
    # before, it is 3: 1 for ELA, 1 for SCI, 1 for MATH. Need to make it 1:1 prior to merge
    metric_cols = [c for c in standardized_testing_results_df.columns 
